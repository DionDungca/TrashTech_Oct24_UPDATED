    ...
    include 'template.php'; // Include sidebar.php to ensure the sidebar is rendered
    ...
    <head>
        ...
        <style>
            ...
            #content {
                margin-left: -740px; /* Adjust this value based on the actual sidebar width */
                padding: 20px;
                width: calc(100% - 0px); /* Adjust width to account for sidebar width */
