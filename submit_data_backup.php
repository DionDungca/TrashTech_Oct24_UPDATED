...
if (!is_null($plastic_level) && !is_null($plastic_weight)) {
    $plastic_level_query = "INSERT INTO plastic_level (level, measured_at, company_name) VALUES ($plastic_level, NOW(), '$company_name')";
    $plastic_weight_query = "INSERT INTO plastic_weight (weight, measured_at, company_name) VALUES ($plastic_weight, NOW(), '$company_name')";
...
if (!is_null($glass_level) && !is_null($glass_weight)) {
    $glass_level_query = "INSERT INTO glass_level (level, measured_at, company_name) VALUES ($glass_level, NOW(), '$company_name')";
    $glass_weight_query = "INSERT INTO glass_weight (weight, measured_at, company_name) VALUES ($glass_weight, NOW(), '$company_name')";
...
if (!is_null($metal_level) && !is_null($metal_weight)) {
    $metal_level_query = "INSERT INTO metal_level (level, measured_at, company_name) VALUES ($metal_level, NOW(), '$company_name')";
    $metal_weight_query = "INSERT INTO metal_weight (weight, measured_at, company_name) VALUES ($metal_weight, NOW(), '$company_name')";
...
if (!is_null($paper_level) && !is_null($paper_weight)) {
    $paper_level_query = "INSERT INTO paper_level (level, measured_at, company_name) VALUES ($paper_level, NOW(), '$company_name')";
    $paper_weight_query = "INSERT INTO paper_weight (weight, measured_at, company_name) VALUES ($paper_weight, NOW(), '$company_name')";
