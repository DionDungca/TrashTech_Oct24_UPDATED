...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validate if a company is selected or being registered
...
<div class="container">
    <div class="left-section">
        ...
        <form action="signup.php" method="POST">
            ...
            <select name="role" id="role" onchange="toggleCompanyCodeField()">
            ...
            <div class="contact-number-wrapper">
                ...
                <input type="text" name="contact_number" maxlength="10" class="contact-number" required>
            </div>
